...
DATADIR = '/media/66AAFEE6AAFEB223/Users/Antonio/Downloads/imagenet/zip'
OUTPUTDIR = '/media/66AAFEE6AAFEB223/Users/Antonio/Downloads/imagenet/batches/imagesize-%d' % IMAGESIZE
...
def synid_to_label():
  lines = open('/media/66AAFEE6AAFEB223/Users/Antonio/Downloads/imagenet/synid-to-label').read().strip().split('\n')
